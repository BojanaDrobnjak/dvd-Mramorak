...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function burnBurnBurn() {
      ...
      // draw random pixels at the bottom line(x1,y1,x2,y2)
      ...
      var skipRows = 2;  // skip the bottom 2 getRows()
  
      // render the flames using our color table
      for(y = skipRows; y < canvasHeight; ++y) {
        for(x = 0; x < canvasWidth; ++x) {
          var index = y * canvasWidth * 4 + x * 4;
          value = fire[(y - skipRows) * canvasWidth + x];
